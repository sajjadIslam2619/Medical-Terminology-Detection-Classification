...
OUT_FILES = {
    ...
    'assertion_label_modified_train': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_label_modified_train.tsv'),
    'assertion_label_modified_dev': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_label_modified_dev.tsv'),
    'assertion_label_modified_test': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR,
                                                    'assertion_label_modified_test.tsv'),
    'assertion_3_label_modified_train': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_3_label_modified_train.tsv'),
    'assertion_3_label_modified_dev': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_3_label_modified_dev.tsv'),
    'assertion_3_label_modified_test': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR,
                                                    'assertion_3_label_modified_test.tsv'),
    'assertion_4_label_modified_train': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_4_label_modified_train.tsv'),
    'assertion_4_label_modified_dev': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_4_label_modified_dev.tsv'),
    'assertion_4_label_modified_test': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR,
                                                    'assertion_4_label_modified_test.tsv'),
    'assertion_5_label_modified_train': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_5_label_modified_train.tsv'),
    'assertion_5_label_modified_dev': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_5_label_modified_dev.tsv'),
    'assertion_5_label_modified_test': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR,
                                                    'assertion_5_label_modified_test.tsv'),
    'assertion_6_label_modified_train': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
                                                    'assertion_6_label_modified_train.tsv'),
    'assertion_6_label_modified_dev': os.path.join(DATA_REFORMAT_AST_LABEL_SAVED_DIR, 
